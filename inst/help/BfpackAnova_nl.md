...
### Specificatie van de bfpack ANOVA
...
- Wanneer de bfpack ANOVA voor het eerst wordt uitgevoerd, vink dan de beide aanvullende statistieken en beide grafieken aan. Wanneer de gebruiker dan terug gaat naar de bfpack ANOVA is het duidelijk wat deze vier opties inhouden, en kunnen de benodigde opties worden geselecteerd. 
...
### Verkregen resultaten na het uitvoeren van de bfpack ANOVA

- Om de resultaten van de bfpack ANOVA goed te kunnen interpreteren, kunt u de TUTORIAL van Hoijtink, Mulder, van Lissa, and Gu (2018) lezen. Deze kan worden gevonden op de Psychological Methods website, of op de bfpack website via https://informative-hypotheses.sites.uu.nl/software/bfpack/
...
- Na het uitvoeren van de bfpack ANOVA worden vijf resultaten verkregen:
