...
test_that("prenumb - postnumb plot matches", {
	plotName <- results[["results"]][["bfpackContainer"]][["collection"]][["bfpackContainer_descriptivesPlots"]][["collection"]][["bfpackContainer_descriptivesPlots_prenumb - postnumb"]][["data"]]
...
test_that("prenumb - postnumb plot matches", {
	plotName <- results[["results"]][["bfpackContainer"]][["collection"]][["bfpackContainer_posteriorProbabilityPlot"]][["collection"]][["bfpackContainer_posteriorProbabilityPlot_prenumb - postnumb"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
