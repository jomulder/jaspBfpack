...
options <- jaspTools::analysisOptions("bfpackAncovaBayesian")
...
set.seed(1)
results <- jaspTools::runAnalysis("bfpackAncovaBayesian", "sesame.csv", options)
...
test_that("Adjusted Means plot matches", {
	plotName <- results[["results"]][["bfpackContainer"]][["collection"]][["bfpackContainer_descriptivesPlots"]][["data"]]
...
test_that("Bfpack ANCOVA table results match", {
